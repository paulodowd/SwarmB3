...
IRParser_c parser[3] = {  SerialA4, SerialD12, SerialSPI };
...
//  sercomInvert(SERCOM0, false, false); // SerialA4
...
//      Serial.print( SerialA4.read(), HEX);
//
//    }
//    Serial.println();
//  }
...
//    Serial.println( SerialD12.read(), HEX);
//
//  }

  if ( SerialSPI.available() ) {
    Serial.print("SPI: ");
    while ( SerialSPI.available() ) {
//      Serial.print( SerialSPI.read(), HEX);
